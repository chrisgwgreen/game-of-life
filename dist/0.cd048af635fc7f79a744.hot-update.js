...
class Grid extends React.Component {
    ...
    click(e) {
        ...
        console.log(e.clientX - bounding.left, e.clientY - bounding.top, cellSize);

        console.log(Math.floor((e.clientX - bounding.left) / cellSize), Math.floor((e.clientY - bounding.top) / cellSize));
    }
